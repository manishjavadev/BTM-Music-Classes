...
<section id="portfolio">
	<div class="container">
		...
		<ul class="portfolio-filter text-center">
			<li><a class="btn btn-default active" href="#" data-filter="*">Instruments</a></li>
			<li><a class="btn btn-default" href="#" data-filter=".bootstrap">Guitar</a></li>
			<li><a class="btn btn-default" href="#" data-filter=".html">Piano</a></li>
			<li><a class="btn btn-default" href="#" data-filter=".wordpress">Violin</a></li>
		</ul>
		<!--/#portfolio-filter-->
