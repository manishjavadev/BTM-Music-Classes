					...
					<div class="row slide-margin">
						<div class="col-sm-6">
							<div class="carousel-content">
								<h1 class="animation animated-item-1">BTM Music Class</h1>
								<h2 class="animation animated-item-2">BTM Music Classes
									LEARN FROM PROFESSIONALS...</h2>
								<a class="btn-slide animation animated-item-3" href="#">Read
									More About BTM Music Class</a>
							</div>
						</div>
